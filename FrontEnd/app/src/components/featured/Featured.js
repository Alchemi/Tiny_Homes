    ...
    return (
        ...
        <div className='container'>
                ...
                <div className='span-2 right-img-details order-7'>
                    <p>A beautiful modern day home located on quiet peaceful area. Cozy and home located in Texas. Including media room, back deck, and built-in kitchen area. </p>
                    <button className='btn'>View Listing</button>
                </div>
                ...
                <div className='span-3 img-details order-6'>
                    <div className='top'>
                        <h2>100 Main St. Richland, TX</h2>
                        <p>House for Sale</p>
                        <p className='price'>$87,000</p>
                    </div>
                    <div className='info-grid'>
                        <div>
                            <div className='info'>
                        ...
                        <div>
                            <div className='info'>
                                <p className='bold'>Square Feet:</p><p>2,138</p>
                            </div>
                            <div className='info'>
                                <p className='bold'>Est Payment:</p><p>$1,200/mo</p>
                            </div>
                        </div>
                    </div>
                </div>
